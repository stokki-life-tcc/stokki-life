...
<body class="bg-stokki-gray-light font-sans antialiased fade-in">
    ...
    <section id="funcionalidades" class="max-w-7xl mx-auto px-6 py-16">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white p-6 rounded-lg shadow text-center">
                ...
                <p class="text-stokki-gray-text mt-2">Cadastre produtos, controle entradas e saídas, e receba alertas de
                    estoque baixo.</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow text-center">
                ...
                <p class="text-stokki-gray-text mt-2">Venda por copo ou fechado, com atualização automática do estoque.
                </p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow text-center">
                ...
                <p class="text-stokki-gray-text mt-2">Controle pagamentos pendentes e marque como recebido com um
                    clique.</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow text-center">
                ...
                <p class="text-stokki-gray-text mt-2">Veja os produtos mais vendidos e os que estão parados no estoque.
                </p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow text-center">
            ...
            <div class="bg-white p-6 rounded-lg shadow text-center">
                ...
                <p class="text-stokki-gray-text mt-2">Controle quem acessa informações sensíveis como custo e
                    fornecedores.</p>
            </div>
        </div>
    </section>
    ...
    <section id="faq" class="max-w-4xl mx-auto px-6 py-16">
        ...
        <ul class="space-y-6 text-stokki-gray-text">
            <li><strong>O Stokki funciona para lojas físicas e online?</strong><br>Sim! O sistema é flexível e atende
                qualquer tipo de operação.</li>
            <li><strong>Consigo usar mesmo tendo feito controle manual?</strong><br>Claro! A interface é simples e
                pensada para quem nunca usou sistema.</li>
            <li><strong>O sistema ajuda a evitar perdas?</strong><br>Sim! Com alertas de vencimento e estoque baixo,
                você evita desperdícios.</li>
    ...
    <section id="video" class="max-w-5xl mx-auto px-6 py-16">
        ...
        <p class="text-center text-stokki-gray-text mb-6">Assista ao vídeo e descubra como o Stokki-Life pode
            transformar a gestão do seu negócio.</p>
        <div class="aspect-w-16 aspect-h-9">
            <iframe class="w-full h-96 rounded" src="https://www.youtube.com/embed/dQw4w9WgXcQ"
